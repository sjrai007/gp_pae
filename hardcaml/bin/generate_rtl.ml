(* Elaborates [Gp_pae.Core] and writes the Verilog Tiny Tapeout's flow
...
let () =
  let circuit = Circuit.create_with_interface ~name:"gp_pae_core" (module Core.I) (module Core.O) Core.create in
